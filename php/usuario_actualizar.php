<?php
    ...
    //verificando el admin, el usuario que lo modifica debe ser el mismo que inicio sesion
    ...
    if($clave_1!="" || $clave_2!=""){
        if(verificar_datos("[a-zA-Z0-9$@.-]{7,100}",$clave_1) || verificar_datos("[a-zA-Z0-9$@.-]{7,100}",$clave_2)){
            echo '
                <div class="notification is-danger is-light">
                    <strong>¡Ocurrio un error inesperado!</strong><br>
                    Las CLAVES no coinciden con el formato solicitado debe haber mas de 7 caracteres
                </div>
            ';
            exit();
        }else{
    ...
    if($actualizar_usuario->execute($marcadores)){
        ...
        echo '
            <div class="notification is-danger is-light">
                <strong>¡Ocurrio un error inesperado!</strong><br>
                No se pudo actualizar el usuario, por favor intentar nuevamente
            </div>
        ';
    }
