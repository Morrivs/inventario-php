<?php
    ...
    if(verificar_datos("[a-zA-Z0-9- ]{1,70}",$codigo)){
        echo '
            <div class="notification is-danger is-light">
                <strong>¡Ocurrio un error inesperado!</strong><br>
                El CODEIGO de BARRAS no coincide con el formato solicitado
            </div>
        ';
        exit();
    }
    ...
    if($_FILES['producto_foto']['name']!="" && $_FILES['producto_foto']['size']>0){
        ...
        //creando el directorio de img
        if(!file_exists($img_dir)){ //verifica si existe el archivo (file_exists)
        ...
        mime_content_type($_FILES['producto_foto']['tmp_name'])!= "image/png"){//verifica el formato de la imagen(mime_content_tyoe)
            echo '
                <div class="notification is-danger is-light">
                    <strong>¡Ocurrio un error inesperado!</strong><br>
        ...
        chmod($img_dir,0777);//da permisos de lectura y escritura el 0777 chmod sirve para modificar el directorio
        ...
        //valida se se ingreso el usuario
        if($guardar_producto->rowCount()==1){
            ...
            if(is_file($img_dir.$foto)){
                chmod($img_dir,0777);
                unlink($img_dir.$foto); //elimina la imagen
            }
